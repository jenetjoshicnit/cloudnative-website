...
const ServiceAIAgents = ({service}) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-agents`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Agents, AI Agents Services, AI Agents Solutions" />
...
export default ServiceAIAgents;
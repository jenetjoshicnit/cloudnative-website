...
const ServiceGenerativeAI = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-generative`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Generative, AI Generative Services, AI Generative Solutions" />
...
export default ServiceGenerativeAI;
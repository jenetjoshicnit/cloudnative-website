...
const Serviceone = ({ service }) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/endpoint-detection-and-response`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="Endpoint Detection and Response, Cybersecurity Services" />

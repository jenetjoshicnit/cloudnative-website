...
const ServiceAISolutions = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-solutions`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Solutions, AI Solutions Services, AI Solutions Solutions" />

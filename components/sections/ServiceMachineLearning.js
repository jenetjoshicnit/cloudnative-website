...
const ServiceMachineLearning = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-machine-learning`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Machine Learning, AI Machine Learning Services, AI Machine Learning Solutions" />
...
export default ServiceMachineLearning;
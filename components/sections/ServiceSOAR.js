...
const Serviceone = ({ service }) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/security-orchestration-automation-and-response`;
  
  return (
    <>
    <Head>
        <title>Security Orchestration, Automation and Response</title>
        <meta name="description" content={pageDescription} />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="keywords" content="Security Orchestration, Automation and Response, Cybersecurity Services" />

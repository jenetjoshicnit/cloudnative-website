...
const ServiceROI = ({service}) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-roi`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI ROI, AI ROI Services, AI ROI Solutions" />

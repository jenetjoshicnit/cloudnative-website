...
const ServiceAIDevelopment = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-development`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Development, AI Development Services, AI Development Solutions" />
...
export default ServiceAIDevelopment;
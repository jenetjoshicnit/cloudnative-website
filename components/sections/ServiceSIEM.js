...
const Serviceone = ({ service }) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/security-information-and-event-management`;

  return (
    <>
    <Head>
        <title>Security Informationa and Event Management</title>
        <meta name="description" content={pageDescription} />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="keywords" content="Security Information and Event Management, Cybersecurity Services" />

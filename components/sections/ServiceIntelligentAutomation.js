...
const ServiceIntelligentAutomation = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-automation`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Intelligent Automation, AI Intelligent Automation Services, AI Intelligent Automation Solutions" />
...
export default ServiceIntelligentAutomation;
...
const Serviceone = ( {service} ) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/service-and-sustainability`;

  return (
    <>
    <Head>
        <title>Service and Sustainability</title>
        <meta name="description" content={pageDescription} />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="keywords" content="IT Maintenance Services, E Waste Management, Chp Level Management" />

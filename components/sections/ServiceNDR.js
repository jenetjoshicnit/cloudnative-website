...
const Serviceone = ({ service }) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/network-detection-and-response`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="Network Detection and Response, Cybersecurity Services" />

...
const ServiceAgenticAI = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-autonomous-systems`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Agentic AI, AI Agentic AI Services, AI Agentic AI Solutions" />
                      ...
                      <ul>
                        {subServices.map((subService, index) => (
                          <li key={subService.id}>
                            <Link className={(index === 0) ? 'current': ''} href={subService.link || ''}>
...
export default ServiceAgenticAI;
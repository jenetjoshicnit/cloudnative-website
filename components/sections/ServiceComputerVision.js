...
const ServiceComputerVision = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-computer-vision`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Computer Vision, AI Computer Vision Services, AI Computer Vision Solutions" />
...
export default ServiceComputerVision;
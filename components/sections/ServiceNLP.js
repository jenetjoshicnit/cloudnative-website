...
const ServiceNLP = ({service}) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-nlp`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Natural Language Processing, AI NLP Services, AI NLP Solutions" />

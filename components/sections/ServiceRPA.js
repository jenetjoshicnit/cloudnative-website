...
const ServiceRPA = ({service}) => {
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-rpa`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI RPA, AI RPA Services, AI RPA Solutions" />

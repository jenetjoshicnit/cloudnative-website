...
const ServiceIntegrationStrategy = ({service}) => {
  if (!service) return <></>;
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL}/ai-integration-strategy`;
  ...
  return (
    ...
    <Head>
        ...
        <meta name="keywords" content="AI Integration Strategy, AI Integration Strategy Services, AI Integration Strategy Solutions" />
...
export default ServiceIntegrationStrategy;
...
export const getServerSideProps = async () => {
    try {
      ...
      const service = result.data?.find((item) => item.title === "IT Infrastructure Solutions") || null;
    ...
    return (
        <>
            <Layout HeaderStyle="one">
                <PageTitle pageName="IT Infrastructure Solutions" />
                <ServiceInfrastructure service={service} />
            </Layout>
        </>
    )
}
